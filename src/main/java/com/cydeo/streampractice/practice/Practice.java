...
import com.cydeo.streampractice.service.impl.CountryServiceImpl;
...
public class Practice {
    ...
    public static List<String> getAllDepartmentManagerFirstNames() {
        //TODO Implement the method
        return departmentService.readAll().stream().map(p->p.getManager().getFirstName()).collect(Collectors.toList());
    }

    // Display all the departments where manager name of the department is 'Steven'
    public static List<Department> getAllDepartmentsWhichManagerFirstNameIsSteven() {
        //TODO Implement the method
        return departmentService.readAll().stream().filter(p->p.getManager().getFirstName().equals("Steven")).collect(Collectors.toList());
    }
    ...
    public static boolean checkIfThereIsNoSalaryLessThan1000() {
        //TODO Implement the method
        return getAllEmployees().stream()
                .noneMatch(p->p.getSalary()<1000); //true
    ...
    public static List<Employee> getAllEmployeesWithLessSalaryThan5000() {
        //TODO Implement the method
        return getAllEmployees().stream()
                .filter(p->p.getSalary()<5000).collect(Collectors.toList());
    }
    ...
    public static List<Employee> getAllEmployeesSalaryBetween() {
        //TODO Implement the method
        return getAllEmployees().stream()
                .filter(p->p.getSalary()>6000 && p.getSalary()<7000).collect(Collectors.toList());
    }
    ...
    public static List<Employee> getSecondMaxSalaryEmployee() {
        //TODO Implement the method
       return getAllEmployees().stream()
               .filter(p->p.getSalary().equals(getSecondMaxSalary()))
               .collect(Collectors.toList());
    }
    ...
    public static List<Employee> getSecondMinSalaryEmployee(){
        //TODO Implement the method
        return getAllEmployees().stream()
                .filter(p-> p.getSalary().equals(getSecondMinSalary()))
                .collect(Collectors.toList());
    ...
    public static Employee getEmployeeOfJobHistoryWhoseStartDateIsFirstDayOfJanuary2007AndEndDateIsLastDayOfDecember2007AndDepartmentNameIsShipping() throws Exception {
        ...
        return getAllJobHistories().stream()
                ...
                .filter(p->p.getDepartment().getDepartmentName().equalsIgnoreCase("shipping"))
    ...
    public static List<Employee> getAllEmployeesDepartmentIdIs50or80or100() {
        //TODO Implement the method
        return getAllEmployees().stream()
                .filter(p->p.getDepartment().getId().equals(50L) || p.getDepartment().getId().equals(80L)
    ...
    public static Integer getLongestNameLength() throws Exception {
        //TODO Implement the method
        return getAllEmployees().stream()
                .map((p->p.getFirstName().length()+p.getLastName().length()+1))
    ...
    public static List<Employee> getLongestNamedEmployee() throws Exception {
        ...
        return getAllEmployees().stream()
                .filter(p->{
                    int length=p.getFirstName().length()+p.getLastName().length()+1;
                    try {
                        if(length==getLongestNameLength()){
                            return true;
                        }else{
                            return false;
                        }
    ...
    public static List<Employee> getAllEmployeesDepartmentIdIs90or60or100or120or130() {
        //TODO Implement the method
        return getAllEmployees().stream()
                .filter(p->p.getDepartment().getId().equals(90L)||
                        p.getDepartment().getId().equals(60L)||
                        p.getDepartment().getId().equals(100L)||
                        p.getDepartment().getId().equals(120L)||
                        p.getDepartment().getId().equals(130L))
                .collect(Collectors.toList());
    }
